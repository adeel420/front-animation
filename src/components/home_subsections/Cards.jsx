...
const Cards = () => {
    ...
    if (wrapperRef.current && containerRef.current) {
      ...
      gsap.to(wrapperRef.current, {
        ...
        scrollTrigger: {
          ...
          start: "top top",
          end: () => "+=" + totalWidth * 1.5, // increase scroll distance to slow animation
          scrub: 1.5, // lower number = slower, smoother
          pin: true,
        },
      });
    }
  ...
  return (
    <div
      ref={containerRef}
      className="relative"
      style={{ height: "200vh" }} // increase height for smoother scroll
    >
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        <motion.div ref={wrapperRef} className="flex items-center gap-10 pl-20">
          {cardsData.map((card, index) => (
            <div
              key={index}
              className="card rounded-2xl p-3 sm:p-4 shadow-lg w-[260px] sm:w-[260px] md:w-[300px] lg:w-[340px] flex-shrink-0 transition-transform duration-500 hover:scale-105"
            >
